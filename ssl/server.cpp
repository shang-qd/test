...
#define CERTF  "D:\\MyTestCA\\server\\serverApp.pem" //"client.crt"  /*客户端的证书(需经CA签名)*/  
#define KEYF  "D:\\MyTestCA\\server\\PK.pem" //"client.key"   /*客户端的私钥(建议加密存储)*/  
#define CACERT "D:\\MyTestCA\\MyTestCA_Certificate.pem" // "ca.crt"      /*CA 的证书*/ 
...
static int PasswordCB(char *buf, int size, int flag, void *userdata)
{
